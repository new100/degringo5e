...
export default class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      typeIcon: "systems/degringo5e/icons/svg/hit-points.svg",
      title: game.i18n.localize("DEGRINGO5E.ADVANCEMENT.HitPoints.Title"),
      hint: game.i18n.localize("DEGRINGO5E.ADVANCEMENT.HitPoints.Hint"),
      multiLevel: true,
      apps: {
  ...
  /** @inheritDoc */
  get levels() {
    return Array.fromRange(CONFIG.DEGRINGO5E.maxLevel + 1).slice(1);
  }
  ...
  #getApplicableValue(value) {
    const abilityId = CONFIG.DEGRINGO5E.defaultAbilities.hitPoints || "con";
