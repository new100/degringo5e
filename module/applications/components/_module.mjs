...
window.customElements.define("degringo5e-checkbox", CheckboxElement);
window.customElements.define("degringo5e-effects", EffectsElement);
window.customElements.define("degringo5e-icon", IconElement);
window.customElements.define("degringo5e-inventory", InventoryElement);
