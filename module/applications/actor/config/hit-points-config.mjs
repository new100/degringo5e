...
export default class HitPointsConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/degringo5e/templates/actors/config/hit-points-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.localize("DEGRINGO5E.HitPoints");
  }
  ...
  async _preparePartContext(partId, context, options) {
    ...
    const ability = CONFIG.DEGRINGO5E.abilities[CONFIG.DEGRINGO5E.defaultAbilities.hitPoints];
    const mod = this.document.system.abilities?.[CONFIG.DEGRINGO5E.defaultAbilities.hitPoints]?.mod ?? 0;
  ...
  static async #rollFormula(event, target) {
    try {
      ...
      ui.notifications.error("DEGRINGO5E.HPFormulaError", { localize: true });
      throw error;
    }
  }
