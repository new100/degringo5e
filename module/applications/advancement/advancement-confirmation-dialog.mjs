...
export default class AdvancementConfirmationDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/degringo5e/templates/advancement/advancement-confirmation-dialog.hbs",
      jQuery: false
    });
  }
  ...
  static forDelete(item) {
    return this.createDialog(
      item,
      game.i18n.localize("DEGRINGO5E.AdvancementDeleteConfirmationTitle"),
      game.i18n.localize("DEGRINGO5E.AdvancementDeleteConfirmationMessage"),
      {
  ...
  static forLevelDown(item) {
    return this.createDialog(
      item,
      game.i18n.localize("DEGRINGO5E.AdvancementLevelDownConfirmationTitle"),
      game.i18n.localize("DEGRINGO5E.AdvancementLevelDownConfirmationMessage"),
      {
        icon: '<i class="fas fa-sort-numeric-down-alt"></i>',
        label: game.i18n.localize("DEGRINGO5E.LevelActionDecrease")
      }
    );
  }
