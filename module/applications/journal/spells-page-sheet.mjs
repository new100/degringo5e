    ...
    for ( const data of context.spells ) {
      ...
      switch ( context.grouping ) {
        case "level":
          ...
          section = context.sections[level] ??= { header: CONFIG.DEGRINGO5E.spellLevels[level], spells: [] };
          break;
        case "school":
          const school = spell.system.school;
          section = context.sections[school] ??= { header: CONFIG.DEGRINGO5E.spellSchools[school]?.label, spells: [] };
          break;
        case "alphabetical":
